...
class AppLocalizations {
  static const _translations = {
    ...
    'zh-CN': {
      ...
      'settings_local_model': '本地模型（离线 GGUF）',
      ...
      'blog_address': '博客地址',
      'pwa_guide': 'PWA 说明',
      'pwa_guide_hint': '站点已部署 Cloudflare Pages，可在浏览器"添加到主屏幕"',
      'cloudflare_hook': 'Cloudflare 部署钩子',
      ...
      'cloudflare_hook_saved': 'Cloudflare 部署钩子已保存',
      'deploy_hook_configured': '已配置（发布后自动触发重新部署）',
      'deploy_hook_not_configured': '未配置（发布后需手动触发部署）',
      'deploy_hook_title': 'Cloudflare Deploy Hook',
      'deploy_hook_desc': '在 Cloudflare Pages → 项目设置 → Deploy Hooks 中创建钩子，粘贴 URL 到此处。发布文章后将自动触发重新部署。',
      'deploy_hook_label': 'Deploy Hook URL',
      'deploy_hook_hint': 'https://api.cloudflare.com/...',
      ...
      'hexo_writing_system': 'Hexo 写作管理系统',
      ...
      'local_model_hint': '导入 .gguf 文件，配置推理设备 / 上下文 / 采样参数后完全离线使用',
    ...
    'en': {
      ...
      'settings_local_model': 'Local Models (Offline GGUF)',
      ...
      'local_gguf_model': 'Local GGUF Model',
      ...
      'pwa_guide': 'PWA Guide',
      'pwa_guide_hint': 'Site is deployed on Cloudflare Pages. Add to home screen in the browser.',
      'cloudflare_hook': 'Cloudflare Deploy Hook',
      ...
      'cloudflare_hook_saved': 'Cloudflare deploy hook saved',
      'deploy_hook_configured': 'Configured (auto re-deploys after publish)',
      'deploy_hook_not_configured': 'Not configured (manual deploy needed after publish)',
      'deploy_hook_title': 'Cloudflare Deploy Hook',
      'deploy_hook_desc': 'Create a hook in Cloudflare Pages → Project Settings → Deploy Hooks and paste the URL here. Publishing an article will trigger re-deployment automatically.',
      'deploy_hook_label': 'Deploy Hook URL',
      'deploy_hook_hint': 'https://api.cloudflare.com/...',
      ...
      'hexo_writing_system': 'Hexo Writing Management System',
      ...
      'local_model_hint': 'Import .gguf files, configure inference device / context / sampling params for fully offline use',
    ...
    'ja': {
      ...
      'settings_local_model': 'ローカルモデル（オフライン GGUF）',
      ...
      'local_gguf_model': 'ローカル GGUF モデル',
      ...
      'pwa_guide': 'PWA ガイド',
      'pwa_guide_hint': 'Cloudflare Pages にデプロイ済み。ブラウザでホーム画面に追加できます。',
      'cloudflare_hook': 'Cloudflare デプロイフック',
      ...
      'cloudflare_hook_saved': 'Cloudflare デプロイフックを保存しました',
      'deploy_hook_configured': '設定済み（公開後に自動再デプロイ）',
      'deploy_hook_not_configured': '未設定（公開後に手動デプロイが必要）',
      'deploy_hook_title': 'Cloudflare Deploy Hook',
      'deploy_hook_desc': 'Cloudflare Pages → プロジェクト設定 → Deploy Hooks でフックを作成し、URL をここに貼り付けます。記事を公開すると自動的に再デプロイされます。',
      'deploy_hook_label': 'Deploy Hook URL',
      'deploy_hook_hint': 'https://api.cloudflare.com/...',
      ...
      'hexo_writing_system': 'Hexo ライティング管理システム',
      ...
      'local_model_hint': '.gguf ファイルをインポートし、推論デバイス / コンテキスト / サンプリングパラメータを設定すると完全オフラインで使用できます。',
    ...
    'ko': {
      ...
      'settings_local_model': '로컬 모델 (오프라인 GGUF)',
      ...
      'blog_address': '블로그 주소',
      'pwa_guide': 'PWA 안내',
      'pwa_guide_hint': 'Cloudflare Pages에 배포되어 브라우저에서 홈 화면에 추가할 수 있습니다.',
      'cloudflare_hook': 'Cloudflare 배포 훅',
      ...
      'cloudflare_hook_saved': 'Cloudflare 배포 훅이 저장되었습니다',
      'deploy_hook_configured': '구성됨 (게시 후 자동 재배포)',
      'deploy_hook_not_configured': '구성되지 않음 (게시 후 수동 배포 필요)',
      'deploy_hook_title': 'Cloudflare Deploy Hook',
      'deploy_hook_desc': 'Cloudflare Pages → 프로젝트 설정 → Deploy Hooks에서 훅을 만들고 여기에 URL을 붙여넣으세요. 글을 게시하면 자동으로 재배포됩니다.',
      'deploy_hook_label': 'Deploy Hook URL',
      'deploy_hook_hint': 'https://api.cloudflare.com/...',
      ...
      'hexo_writing_system': 'Hexo 글쓰기 관리 시스템',
      ...
      'local_model_hint': '.gguf 파일을 가져오고 추론 장치 / 컨텍스트 / 샘플링 매개변수를 구성하면 완전히 오프라인으로 사용할 수 있습니다.',
