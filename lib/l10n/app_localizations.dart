...
class AppLocalizations {
  static const _translations = {
    ...
    'zh-CN': {
      ...
      'settings_export_folder': '导出文件夹',
      'export_folder_title': '自定义导出文件夹',
      'export_folder_not_set': '未设置（导出到系统下载目录）',
      'pick_export_folder': '选择/更改',
      'clear_export_folder': '清除',
      'view_export_folder': '查看文件夹内容',
      'pick_export_folder_first': '请先在设置中选择导出文件夹',
      'export_folder_contents': '导出文件夹内容',
      'export_folder_empty': '文件夹为空',
      'export_folder_hint': '通过系统文件夹选择器授权一个外部目录，MD 导出优先保存到该文件夹。您的草稿始终保存在应用内部，不受影响。',
      'external_saf_dir_set': '已设置导出文件夹: {name}',
      'external_saf_dir_cleared': '已清除导出文件夹授权',
      'migrating_title': '正在迁移文件…',
      'migrating_progress': '已处理 {count} 项',
    ...
    'en': {
      ...
      'settings_export_folder': 'Export Folder',
      'export_folder_title': 'Custom Export Folder',
      'export_folder_not_set': 'Not set (exports to system Downloads)',
      'pick_export_folder': 'Pick / Change',
      'clear_export_folder': 'Clear',
      'view_export_folder': 'View folder contents',
      'pick_export_folder_first': 'Please choose an export folder in Settings first',
      'export_folder_contents': 'Export folder contents',
      'export_folder_empty': 'The folder is empty',
      'export_folder_hint': 'Authorize an external folder via the system folder picker. MD exports are saved there first. Your drafts always stay in the app private storage.',
      'external_saf_dir_set': 'Export folder set: {name}',
      'external_saf_dir_cleared': 'Export folder authorization cleared',
      'migrating_title': 'Migrating files…',
      'migrating_progress': '{count} processed',
    ...
    'ja': {
      ...
      'settings_export_folder': 'エクスポートフォルダ',
      'export_folder_title': 'カスタムエクスポートフォルダ',
      'export_folder_not_set': '未設定（システムのダウンロードへ出力）',
      'pick_export_folder': '選択 / 変更',
      'clear_export_folder': 'クリア',
      'view_export_folder': 'フォルダ内容を表示',
      'pick_export_folder_first': '設定でエクスポートフォルダを先に選択してください',
      'export_folder_contents': 'エクスポートフォルダ内容',
      'export_folder_empty': 'フォルダは空です',
      'export_folder_hint': 'システムのフォルダ選択で外部フォルダを許可します。MD エクスポートはこのフォルダへ優先保存されます。草稿は常にアプリ内部に保持されます。',
      'external_saf_dir_set': 'エクスポートフォルダを設定: {name}',
      'external_saf_dir_cleared': 'エクスポートフォルダの許可を解除',
      'migrating_title': 'ファイルを移行しています…',
      'migrating_progress': '{count} 項目を処理済み',
    ...
    'ko': {
      ...
      'settings_export_folder': '내보내기 폴더',
      'export_folder_title': '사용자 지정 내보내기 폴더',
      'export_folder_not_set': '미설정(시스템 다운로드로 내보내기)',
      'pick_export_folder': '선택 / 변경',
      'clear_export_folder': '지우기',
      'view_export_folder': '폴더 내용 보기',
      'pick_export_folder_first': '설정에서 먼저 내보내기 폴더를 선택하세요',
      'export_folder_contents': '내보내기 폴더 내용',
      'export_folder_empty': '폴더가 비어 있음',
      'export_folder_hint': '시스템 폴더 선택으로 외부 폴더를 허용합니다. MD 내보내기는 이 폴더에 우선 저장됩니다. 초안은 항상 앱 내부에 보관됩니다.',
      'external_saf_dir_set': '내보내기 폴더 설정: {name}',
      'external_saf_dir_cleared': '내보내기 폴더 권한 해제',
      'migrating_title': '파일 마이그레이션 중…',
      'migrating_progress': '{count}개 처리됨',
