...
class AppLocalizations {
  static const _translations = {
    ...
    'zh-CN': {
      ...
      'help_publish': '静态博客发布',
      'help_publish_body': '支持 GitHub Pages / 静态博客 / CMS 多站点一键发布。可配置 Cloudflare Deploy Hook，发布后自动触发重新部署。',
      'help_issue': '遇到问题？',
    ...
    'en': {
      ...
      'help_publish_body': 'One-click publishing to GitHub Pages / static blogs / CMS sites. Configure a Cloudflare Deploy Hook to auto-trigger redeploy after publishing.',
    ...
    'ja': {
      ...
      'help_publish_body': 'GitHub Pages / 静的ブログ / CMS サイトへのワンクリック公開。Cloudflare Deploy Hook を構成すると、公開後に自動で再デプロイがトリガーされます。',
      'help_issue': '問題がありますか？',
    ...
    'ko': {
      ...
      'help_publish_body': 'GitHub Pages / 정적 블로그 / CMS 사이트에 원클릭 발행. Cloudflare Deploy Hook을 구성하면 발행 후 자동으로 재배포됩니다.',
      'help_issue': '문제가 있나요?',
