...
public class ReadWidgetViewsService extends RemoteViewsService {
    ...
    public RemoteViewsFactory onGetViewFactory(Intent intent) {
        return new ReadViewsFactory(intent);
    }
    ...
    private static class ReadViewsFactory implements RemoteViewsFactory {
        ...
        public void onDataSetChanged() {
            mTaskMode = getSharedPreferences(ReadWidgetProvider.PREFS, MODE_PRIVATE)
                    .getBoolean(ReadWidgetProvider.KEY_TASK_MODE, false);
            mLatestPath = NativeQuickNoteStore.latestDraftPath(ReadWidgetViewsService.this);
            String content = "";
        ...
        public RemoteViews getViewAt(int position) {
            ...
            RemoteViews views = new RemoteViews(getPackageName(), R.layout.widget_diary_read_line);
